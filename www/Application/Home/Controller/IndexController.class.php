...
class IndexController extends PublicController{
    ...
    public function index(){
		...
		$hall = $model -> where($map) -> field('username,team,sum(points),pid,avatar,create_at') -> group('user_id') -> where('points > 0 and email <> \'0\'') -> order("sum(points) desc") -> limit(3) -> select();
